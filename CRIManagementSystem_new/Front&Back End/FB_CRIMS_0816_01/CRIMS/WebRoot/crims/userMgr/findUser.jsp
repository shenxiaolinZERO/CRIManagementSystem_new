...
<html>
  <head>
	...
	<script type="text/javascript" src="/easyui/jquery.min.js"></script>
		...
		<script type="text/javascript" src="/js/user_find.js"></script>
...
<body>
			<div class="easyui-panel" title="查询用户" icon="icon-save" style="width: 1250px; height: 420px; margin: 0; padding: 0;">
				...
				<div class="easyui-layout" fit="true">
					<div id="easyui_toolbar" region="north" border="false" style="border-bottom: 1px solid #ddd; height: 50px; margin-top:0;  padding: 10px; background: #fafafa;">
						...
						<div id="searchbtn" style="float: right; padding-right: 10px;">
							<input type="button" name="searchbtn" class="btn" value="查询" onclick="onSearch()" />
