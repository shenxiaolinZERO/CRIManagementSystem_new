	...
	<div>
		<form id="addtask">
			<div style="float: left;">
			  ...
			  <!--<ul id="treeuser" class="easyui-tree" data-options="url:'chooseUserTaskAction',animate:true,checkbox:true"></ul>-->
                 <ul id="treeuser3" class="easyui-tree" data-options="url:'chooseUserTaskAction',animate:true,checkbox:true"></ul>
			...
			<div style="float: left;  margin-left: 15px;">
              ...
              <!-- <ul id="treeuser" class="easyui-tree" data-options="url:'chooseDeviceTaskAction',animate:true,checkbox:true"></ul>-->
                 <ul id="treeuser2" class="easyui-tree" data-options="url:'chooseDeviceTaskAction',animate:true,checkbox:true"></ul>
