			...
			<div style="float: left; margin-left: 20px;width:68%;">
				<div class="easyui-panel" title="设备信息"
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input type="text" class="" id="devBusinesssys"  name="d.devBusinesssys"
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input type="text" class="" id="devCabbegin" name="d.devCabbegin"
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input type="text" class="" id="devCaboccupy" name="d.devCaboccupy"
								placeholder="请输入所占U数">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input type="text" class="" id="devBrandname" name="d.devBrandname"
								placeholder="请输入品牌">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input type="text" class="" id="devModelnum" name="d.devModelnum"
								placeholder="请输入型号">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="radio" value="1"  id="devStatus1" name="d.devStatus"
								checked="checked">
								<label for="devStatus1">正常</label> 
							<input type="radio" value="2"  id="devStatus2" name="d.devStatus"
