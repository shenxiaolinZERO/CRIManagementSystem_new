			...
			<div class="ad-list">
				<ul>
					...
					<li>
						...
						<dl>
							<dd>
								<a href="/CRIMS/security/cabinet/cabinet_add.jsp"
									class="dd-item" target="main-iframe"> 添加机柜 <span
									class="scm dd-ar"></span> </a>
								<ul class="ad-item-list"></ul>
							</dd>
							<dd>
								<a href="/CRIMS/security/cabinet/cabinet_find.jsp"
									class="dd-item" target="main-iframe"> 查询机柜信息 <span
									class="scm dd-ar"></span> </a>
								<ul class="ad-item-list"></ul>
							</dd>
						</dl></li>
