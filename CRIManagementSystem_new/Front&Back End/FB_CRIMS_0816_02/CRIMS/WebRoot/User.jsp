 			...
 			<div id="mydialog" title="新增用户" modal=true  draggable=false class="easyui-dialog" closed=true style="width:400px;">
	    		<form id="myform" action="" method="post">
						...
						<td><input type="text" name="u.UName"
							...
							invalidMessage="用户名必须在2到7个字符之间!" value="" />
						</td>
					</tr>
					<tr>
						<td>密码:</td>
						<td><input type="password" name="u.UPassword"
							...
							invalidMessage="密码必须在6到18个字符之间!" value="" />
						</td>
					</tr>
					<tr>
						<td>性别:</td>
						<td>男<input type="radio" checked="checked" name="u.USex"
							value="1" /> 女<input type="radio" name="u.USex" value="2" /></td>
					</tr>
					<tr>
						<td>年龄:</td>
						<td><input id="u.UAge" type="text" name="u.UAge"
							...
							invalidMessage="年龄必须在1到13个字符之间!" value="" />
						</td>
					</tr>
					...
					<tr>
						...
						<td><input id="u.UTel" type="text" name="u.UTel"
							...
							missingMessage="请输入电话号码" invalidMessage="请输入正确的电话号码!" value="" />
	    						...
	    						<td>所属城市:</td>
	    						<td>
	    							<input name="u.AId" class="easyui-combobox" url="getAreaUserAction" valueField="AId" textField="AName"  value="" />
	    						</td>
	    					</tr>
	    			<tr>
	    				<td>地址:</td>
					...
					<tr>
						...
						<td><input type="text" name="u.UEmail"
							...
							missingMessage="请输入邮箱!" invalidMessage="请输入正确的邮箱!" value="" />
						</td>
					</tr>
					<tr>
						<td>角色:</td>
