			...
			<div class="ad-list">
				<ul>
					...
					<li>
						...
						<dl>
							<dd>
								<a href="/CRIMS/security/user/User.jsp" class="dd-item"
									target="main-iframe"> 用户管理 <span class="scm dd-ar"></span>
								</a>
					...
					<li>
						...
						<dl>
							<dd>
								<a href="/CRIMS/security/compRoom/CompRoom.jsp"
									class="dd-item" target="main-iframe"> 机房管理 <span
									class="scm dd-ar"></span> </a>
								<ul class="ad-item-list"></ul>
							</dd>
						</dl></li>
					...
					<li>
						<div class="li-item" id="ComputerRoom">
							<em class="scm li-ico ic3"></em> 机柜管理 <span class="scm arrow"></span>
						</div>

						<dl>
							<dd>
								<a href="/CRIMS/security/cabinet/Cabinet.jsp"
									class="dd-item" target="main-iframe"> 机柜管理 <span
									class="scm dd-ar"></span> </a>
								<ul class="ad-item-list"></ul>
							</dd>
						</dl>
					...
					<div class="ad-top-right">
						...
						<div class="ad-welcom">
							...
							<div class="ad-wel-text">
								<div class="font-wel">
									欢迎您！ <p>${role.RPost}<strong>沈小0</strong></p>										
									<div id="setDateTime" style="float:left">
										
									</div>	
									<div style="float:left">
										<a href="login.jsp" > <strong>【退出】</strong> </a>
									</div>	
								</div>
