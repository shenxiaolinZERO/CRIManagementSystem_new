    ...
    <form class="form-horizontal" role="form" action="addUserAction">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                ...
                <input type="radio" value="female" name="u.USex" style="margin-left: 30px;">女
            </div>
        </div>
        <div class="form-group">
            <label for="create-time" class="col-sm-2 control-label" >创建时间：</label>
            <div class="col-sm-2">
                <input type="text" class="form-control" id="create-time"
                       placeholder="请输入出生年月" name="u.UCreatetime">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
			...
			<input type="radio" value="1" name="rid" id="superAdmin" checked="checked" ><label for="superAdmin">系统管理员</label>
			<input type="radio" value="2" name="rid" id="comAdmin" style="margin-left: 30px;"><label for="comAdmin">值班班长</label>
			<input type="radio" value="3" name="rid" id="purchaser" style="margin-left: 30px;" ><label for="purchaser">值班人员</label>
